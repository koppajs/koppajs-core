...
export class Model<T extends Record<string, any>> {
  private callback: ModelCallback; // Callback invoked when a value changes.
   ...
   * @param {ModelCallback} callback - Function to handle value changes.
   */
  constructor(modelData: T, callback: ModelCallback) {
